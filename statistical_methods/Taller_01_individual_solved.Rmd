...
A continuación se ilustran las variables temperatura y humedad relativa es forma de gráfico de dispersión, el cual nos indica cuánto afecta una variable a la otra. Se puede observar que ambas variables tienen un comportamiento inverso, es decir a bajas temperaturas se registró altos valores de humedad relativa en el ambiente; a medida que la temperatura incrementa, la humedad relativa desciende hasta alcanzar su valor mínimo alrededor del 40%.  
